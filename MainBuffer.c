 ...
 * -------------------------------------------------------------
 */
carthage_nul bErrorPrint(carthage_chr* fmt, ...);
carthage_nul displayBuffer(Buffer* ptr_Buffer);
carthage_lng getFileSize(carthage_chr* fname);
carthage_int isNumber(const carthage_chr* ns);
carthage_nul startBuffer(carthage_chr*, carthage_chr*, carthage_chr, carthage_int, carthage_int);
...
carthage_int mainBuffer(carthage_int argc, carthage_chr** argv) {
	...
	carthage_chr* program = argv[0];
	carthage_chr* input = argv[2];
	carthage_chr mode = MODE_FIXED;
	carthage_int isAnsiC = !ANSI_C;		/* ANSI C flag */
	carthage_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
void startBuffer(carthage_chr* program, carthage_chr* input, carthage_chr mode, carthage_int size, carthage_int increment) {

	BufferPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	carthage_int loadSize = 0;			/* the size of the file loaded in the buffer */
	carthage_chr symbol;				/* symbol read from input file */
...
carthage_int isNumber(const carthage_chr* ns) {
	carthage_chr c; carthage_int i = 0;
	if (ns == NULL) return 0;
	while ((c = ns[i++]) == 0) {
