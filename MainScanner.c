...
/* External objects */
extern carthage_int line; /* Source code line numbers - defined in scanner.c */
extern Token tokenizer(carthage_nul);
 ...
 * -------------------------------------------------------------
 */
carthage_nul printScannerError(carthage_chr* fmt, ...);
carthage_nul displayScanner(Buffer* ptrBuffer);
carthage_lng getScannerFilesize(carthage_chr* fname);
